...
if (isset($_POST["btn_add_sp"])) {
    ...
    $stmt = $con->prepare("INSERT INTO specialization (sp_name) VALUES (?)");
    $stmt->bind_param("s", $sp_name);

    if ($stmt->execute()) {
        // Redirect to the specialization page after success
...
<head>
    ...
    <title>Admin Portal - Add Specialization</title>
        ...
        <div class="dashboard_main">
            ...
            <div class="dashboard_content_main">
                <div class="main-content">
                    ...
                    <form method="post">
                        <input type="text" name="sp_name" placeholder="Specialization Name" class="form-control my-4" required>
                        <button type="submit" name="btn_add_sp" class="btn_sp_add">Add Specialization</button>
                    </form>
                </div>
            </div>
        </div>
