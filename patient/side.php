...
<div class="sidebar">
    <div class="profile-section">
        <h4><?php echo htmlspecialchars($patient_name); ?></h4> <!-- Username -->
        <p><?php echo htmlspecialchars($patient_email); ?></p> <!-- Email -->
    </div>
    ...
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="doctor-detail.php">Doctors</a>
        </li>
    </ul>
</div>
