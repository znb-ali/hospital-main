...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Return the message to the front-end for AJAX purposes
    echo json_encode(array('message' => $message));
    exit; // Stop the script from further processing
}
?>
<!DOCTYPE html>
<html lang="zxx">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-us-form wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <!-- Success message -->
                        <div id="msgSubmit" class="h3" style="color: green; text-align: center; display: none;"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                form.addEventListener("submit", function (event) {
                    ...
                    xhr.onload = function () {
                        if (xhr.status === 200) {
                            ...
                            successMessage.style.color = "#96d4f0";
