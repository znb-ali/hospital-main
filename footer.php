					...
					<div class="col-lg-4 col-md-12">
						...
						<div class="about-footer">
							...
							<div class="footer-logo">
								<figure>
								<img style=" width:100px; height : 110px;" src="images/new_care.png"  class="logo" alt="">
								</figure>
							</div>
							<!-- Footer Logo End -->
					...
					<div class="col-lg-3 col-md-5">
						...
						<div class="footer-newsletter">
							...
							<div class="footer-newsletter-form">
								<form id="newslettersForm" action="index.php#" method="POST">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="footer-copyright-text">
								<p>copyright 2024 ©<span>Care</span> all right reserved.</p>
							</div>
